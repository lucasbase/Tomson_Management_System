    ...
    public partial class Owner_Management : Form
    {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds = DBHepler.GetDataSet(shuliangjian);
                ...
                {  //删除对应水费表、电费表、物业管理费表的信息
                    ...
                    if (DBHepler.ExecuteNonQuery(electricdelSql) && DBHepler.ExecuteNonQuery(propertyfeedelSql) && DBHepler.ExecuteNonQuery(waterdelSql) && DBHepler.ExecuteNonQuery(upSql) && DBHepler.ExecuteNonQuery(shao))
                    {
                        //删除业主信息SQL语句
